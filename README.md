...
2. 머신러닝 전략들 - regression보다 하락, 횡보, 상승 3개로 나눠서 classification이 성능상 더 좋을 수도 있겠다.
...
- 매수 조건에 의해 산 뒤에 팔 때 최고가 대비 5퍼 미만 됐을 때 무조건 매도하는게 아니라 일정 조건 이상 충족하면 매도하는 시스템이면 괜찮을듯? ma 밑으로 떨어졌다거나..
...
기술적 분석 자료들 요약 정리
기술적 분석만 사용해서 끝판왕 전략 만들기

머신러닝 이용 다음날 종가 예측 regression
머신러닝 이용 다음날 종가 classification

기술적 분석 + 머신러닝 예측 자료 활용 전략 만들기
